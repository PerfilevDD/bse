...
class PairSelector(Tk):
    ...
    def create_pair_selector_window(self):
        ...
        for trading_pair in self.trading_pairs:
            ...
            string = " " * 7 + string
            self.listbox_pairs.insert(trading_pair["pair_id"] + 1, string)

        selector = Button(self.mainframe, text="Select", command=self.select_pair, width=32, height=2, bg="green", fg="white")
